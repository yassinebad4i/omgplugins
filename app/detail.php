 ...
 * Displays individual app with full details, SEO, and download tracking
 */
...
if (isset($_GET['download'])) {
    $frontend->trackDownload($app['id'], 'app');
...
$downloads = $frontend->getDownloadCount($app['id'], 'app');
$features = json_decode($app['features'] ?? '[]', true);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    <?php echo $frontend->renderMetaTags($app, 'app'); ?>
...
<body>
    ...
    <main class="container">
        <div class="breadcrumb">
            <a href="/">Home</a> / <a href="/app/">Apps</a> / <span><?php echo Security::escape($app['title'] ?? ''); ?></span>
        </div>
        ...
        <div class="hero">
            ...
            <div class="hero-content">
                <h1><?php echo Security::escape($app['title'] ?? ''); ?></h1>
                
                <div class="meta-info">
                    <div class="meta-item">
                        <div class="meta-label">Version</div>
                        <div class="meta-value"><?php echo Security::escape($app['version'] ?? '1.0'); ?></div>
                    </div>
                    <div class="meta-item">
                    ...
                    <div class="meta-item">
                        ...
                        <div class="meta-value"><?php echo Security::escape($app['category'] ?? 'N/A'); ?></div>
                    </div>
                </div>
                
                <div class="buttons">
                    <a href="?download=1" class="btn btn-primary">⬇️ Download Now</a>
                    <a href="<?php echo !empty($app['download_url']) ? Security::escape($app['download_url']) : '#'; ?>" target="_blank" class="btn btn-secondary">🔗 Visit Site</a>
                </div>
                
                <div style="color: #6b7fa3; font-size: 0.9rem;">
                    <p>Published: <?php echo date('M d, Y', strtotime($app['created_at'] ?? 'now')); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="section">
            ...
            <div class="description">
                <?php echo nl2br(Security::escape($app['description'] ?? '')); ?>
            </div>
        </div>
        <?php endif; ?>
        ...
        <div class="section">
            ...
            <div class="features-grid">
                ...
                <div class="feature-item">
                    <span><?php echo Security::escape($feature); ?></span>
                </div>
                <?php endforeach; ?>
            </div>
        </div>
        ...
        <div class="section">
            <h2 class="section-title"><span></span>Specifications</h2>
            <div class="specs">
                <div class="spec-item">
                    <div class="meta-label">Category</div>
                    <div class="spec-value"><?php echo Security::escape($app['category'] ?? 'N/A'); ?></div>
                </div>
                <div class="spec-item">
                    <div class="meta-label">Version</div>
                    <div class="spec-value"><?php echo Security::escape($app['version'] ?? '1.0'); ?></div>
                </div>
                <div class="spec-item">
                    <div class="meta-label">Downloads</div>
                ...
                <div class="spec-item">
                    ...
                    <div class="spec-value"><?php echo date('M d, Y', strtotime($app['updated_at'] ?? $app['created_at'] ?? 'now')); ?></div>
                </div>
            </div>
        </div>
    </main>
